...
p twitter
puts "1. Combien y a-t-il de journalists dans cet array ?"
puts "il y a : #{twitter.length} handle dans ce tableau"
puts ""


puts "2. Combien de ces mails contiennent un nombre ?"
c = twitter.count {|v| v =~ /[0-9]/}
puts "il y a #{c} handle avec un numéro."
puts ""



puts "3. Combien d'handle contiennent les 4 lettres du prénom \"Aude\" à la suite (sans prendre en compte les majuscules) ?"
found3 = twitter.count {|v| v =~ /aude/}
puts "Il y a #{found3} handle avec les 4 lettres du prénom \"aude\" !"
puts ""


puts "4. Combien commencent par une majuscule (première lettre juste après le @) ?"
m = twitter.count {|v| v =~ /^@[A-Z]/}
puts " Il y a #{m} mail avec une majuscule après le @ !"
puts ""

puts "5. Combien contiennent une majuscule ?"
found5 = twitter.count {|v| v =~ /[A-Z]/}
puts "Il y a #{found5} handle avec une majuscule"
puts ""

puts "6. Combien y a-t-il de underscore _ dans tous les pseudos confondus ?"
found6 = twitter.count {|v| v =~ /_/}
puts "Il y a #{found6} handles qui contiennent un underscore"
puts ""
...
50.times do
  ...
  smallest = twitter.min
  index_min=twitter.find_index(smallest)
  twitter.delete_at(index_min.to_i)
  tab << smallest
end
p tab
...
puts "La position de cette personne est : #{twitter.find_index("@epenser")} dans l'array des journalists."
